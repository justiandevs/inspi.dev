    ...
    <nav className="bg-white dark:bg-zinc-800">
      <div className="container-bsc flex justify-between items-center py-8">
        <div className="flex flex-row gap-8 items-center">
          ...
          <Link href="/projects" className="transition duration-300 hover:text-indigo-700 hover:dark:text-indigo-400">
            Projects
          </Link>
        </div>
        <div className="flex flex-row gap-8 items-center">
          ...
          {/*</Link>*/}
          <Link href="/login" className="transition duration-300 hover:text-indigo-700 hover:dark:text-indigo-400">
            Login
          </Link>
          <ThemeToggle />
        </div>
